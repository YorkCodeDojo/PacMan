...
namespace NPacMan.Game.Tests.GameTests
{
    public class DirectChaseToPacManStrategyTests
    {
        ...
        //     {
        //         Ghosts = { new Ghost(name, new CellLocation(5, 5), Direction.Left, CellLocation.TopLeft, new DirectChaseToPacManStrategy(), new StandingStillGhostStrategy()) },
        ...
        public void ShouldTurnAtCorner()
        {
            ...
            var board = new TestGameSettings()
            {
                Ghosts = { new Ghost(name, new CellLocation(1, 2), Direction.Up, CellLocation.TopLeft, new DirectChaseToPacManStrategy(), new StandingStillGhostStrategy()) },
