...
namespace NPacMan.Game.Tests.GameTests
{
    public class PacManTests
    {
        ...
        public void PacManShouldRespawnAfter4Seconds()
        {
            ...
            _gameSettings.Ghosts.Add(new Ghost("Ghost1", new CellLocation(1, 2), Direction.Left, CellLocation.TopLeft, new NPacMan.Game.StandingStillGhostStrategy(), new StandingStillGhostStrategy()));
